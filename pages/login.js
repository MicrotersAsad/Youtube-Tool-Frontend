...
function Login() {
  ...
  const { login } = useContext(AuthContext); // Using AuthContext to manage login state
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Assuming the login context method updates the state across your app
      login(data.token); // Update login state in context
