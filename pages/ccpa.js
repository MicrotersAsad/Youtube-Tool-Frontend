...
const Ccpa = ({ existingContent, meta }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <Head>
        ...
        <meta name="description" content={description || 'Ccpa'} />
        <meta property="og:url" content="https://ytubetools.com/ccpa" />
...
export async function getServerSideProps({ req, locale }) {
  ...
  const apiUrl = `${protocol}://${host}/api/ccpa?language=${locale}`;
  ...
  try {
    ...
    const meta = {
      ...
      description: "This is the Ccpa page for YouTube Tools.",
      image: "https://your-site.com/path-to-your-image.jpg",
      url: `${protocol}://${host}/ccpa`
    };
