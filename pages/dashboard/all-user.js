...
// import { FaTrashAlt, FaTimes, FaBan, FaEdit } from 'react-icons/fa';
...
//       toast.success('User banned and notified successfully!');
//     } catch (error) {
...
//         (user._id === editUser._id ? { ...editUser, profileImage: profileImage ? `/uploads/${profileImage.name}` : editUser.profileImage } : user)
//       ));
//       setEditUser(null);
