    ...
    try {
      ...
      if (result.success && Array.isArray(result.data)) {
        const activeOrders = result.data
          ...
          .reverse(); // Reverse order to display latest subscriptions first
                ...
                <table className="hidden md:table w-full bg-gray-50 rounded-lg overflow-hidden">
                  <thead className="bg-[#071251] text-white">
                    <tr>
                      ...
                      <th className="py-2 px-5 text-left text-xs font-semibold">Account Created</th>
                  ...
                  <tbody>
                    {paginatedOrders.length > 0 ? (
                      ...
                      <tr>
                        <td colSpan="6" className="py-5 text-center text-gray-500 font-medium">
