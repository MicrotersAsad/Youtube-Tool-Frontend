...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`fixed inset-y-0 left-0 z-40 w-64 overflow-y-auto bg-white transition duration-300 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-0`}>
        ...
        <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-gray-200">
          ...
          <div className="flex items-center">
            <div className="relative">
              <input type="text" className="w-full px-4 py-2 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm" placeholder="Search" />
            </div>
          </div>
        </header>
