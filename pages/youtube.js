...
const BlogSection = ({ initialBlogs = [] }) => {
  ...
  return (
    <div className="max-w-7xl container">
        ...
        <meta name="description" content="Explore our Article at Ytubetools for insights, tips, and tools designed to improve your YouTube content creation and viewer experience." />
        <meta property="og:title" content="Ytubetools Article - Tips and Tools for YouTube Creators" />
        ...
        <meta property="og:url" content="https://ytubetools.com/youtube" />
      </Head>
