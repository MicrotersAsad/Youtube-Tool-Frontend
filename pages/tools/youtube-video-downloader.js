  ...
  {JSON.stringify({
    ...
    mainEntity: faqs.map((faq) => ({
      ...
      acceptedAnswer: {
        ...
        <h1 className="text-center text-white">Free YouTube Downloader</h1>
        <p className="text-center text-white">Download your favorite YouTube Video in MP4/MP3 format quickly and effortlessly with our YouTube to MP4 Downloader Online. This tool is completely free, fast, and requires no registration or login.</p>
