...
console.log(formats);
    ...
    const fetchContent = async () => {
      try {
        ...
        const response = await fetch(
          `/api/content?category=youtube-shorts-to-mp4-downloader&language=${language}`
        );
  ...
  const handleReviewSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/reviews", {
        ...
        body: JSON.stringify({
          tool: "youtube-shorts-to-mp4-downloader",
          ...newReview,
      ...
      setShowReviewForm(false);
      fetchReviews("youtube-shorts-to-mp4-downloader");
    } catch (error) {
  ...
  const handleReaction = async (action) => {
    ...
    try {
      const response = await fetch("/api/reactions", {
        ...
        body: JSON.stringify({
          category: "youtube-shorts-to-mp4-downloader",
          userId: user.email,
          action,
        }),
      });
      ...
      <div className="bg-box">
        ...
        <Head>
            ...
            <link
              ...
              href={`${meta?.url
                .toLowerCase()
                .replace("youtube-shorts-to-mp4-downloader", "youtube-shorts-to-mp4-downloader")}`}
            />
            ...
            <meta property="og:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1737885309773-youtubeshortstompdownloader.PNG" />
            <meta property="og:image:secure_url" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1737885309773-youtubeshortstompdownloader.PNG" />
            ...
            <meta
              name="twitter:domain"
              content={meta?.url
                .replace("tools/youtube-shorts-to-mp4-downloader", "")}
            />
            <meta
            ...
            <meta name="twitter:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1737885309773-youtubeshortstompdownloader.PNG" />
            <meta name="twitter:site" content="@ytubetools" />
            <meta name="twitter:image:alt" content="youtube-shorts-to-mp4-downloader" />
  ...
  {JSON.stringify({
    ...
    "@type": "WebPage",
    name: meta?.title,
    url: `${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-shorts-to-mp4-downloader`,
...
<Script id="faq-structured-data" type="application/ld+json">
  {JSON.stringify({
    ...
    mainEntity: faqs.map((faq) => ({
      ...
      <div className="">
        <h1 className="text-center text-white">YouTube Shorts To Mp4 Downloader</h1>
        <p className="text-center text-white">Download your favorite YouTube Shorts as high-quality MP4 videos with our YouTube Shorts to MP4 Downloader. This 100% ad-free tool offers a fast, simple, and seamless way to save Shorts directly to your device.</p>
        <form
...
export async function getServerSideProps(context) {
  return getContentProps("youtube-shorts-to-mp4-downloader", context.locale, context.req);
}
