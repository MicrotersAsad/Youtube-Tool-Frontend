...
//   }, [headerContent]);
  ...
  useEffect(() => {
    // শুধু ক্লায়েন্ট সাইডে `window` অ্যাক্সেস করা যাবে
  ...
  <h1 className="text-3xl text-white">
     ...
     <div className="flex items-start justify-between space-x-4 ms-4 me-4 sm:ms-2 sm:me-2 mt-3 border rounded-lg pt-3 pb-3 ps-3 pe-3">
