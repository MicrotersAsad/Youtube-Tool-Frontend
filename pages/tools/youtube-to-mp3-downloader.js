  ...
  {JSON.stringify({
    ...
    mainEntity: faqs.map((faq) => ({
      ...
      acceptedAnswer: {
        ...
        <p className="text-center text-white">Download your favorite YouTube audio in MP3 format quickly and effortlessly with our YouTube to MP3 Downloader Online. This tool is completely free, fast, and requires no registration or login.</p>
