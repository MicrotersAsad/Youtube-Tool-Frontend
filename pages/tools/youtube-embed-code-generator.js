...
useEffect(() => {
  ...
  const saveChannel = () => {
    ...
    const currentTool = {
      toolName: "YouTube Embed Code Generator", // Name of the current tool
    ...
    <>
      <div className="bg-box">
        ...
        <Head>
            ...
            <meta property="og:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732776294789-youtubeembedcodegeneratora.png"/>
            <meta property="og:image:secure_url" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732776294789-youtubeembedcodegeneratora.png"/>
            ...
            <meta
              name="twitter:domain"
              content={meta?.url
                .replace("tools/YouTube-Embed-Code-Generator", "")}
            />
            <meta
            ...
            <meta name="twitter:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732776294789-youtubeembedcodegeneratora.png"/>
        ...
        {user ? (
          ...
          <>
            ...
            */}
            ...
            <p className="text-center p-3 alert-warning">
              {t(`Hey ${user?.username} You are logged in.Wellcome To YtubeTools. You can now generate unlimited embed code.`)}
            </p>
          </>
        ) : (
          ...
          <p className="text-center p-3 alert-warning">
            {t(
              "You are not logged in. You can generate embed code {{remaining}} more times. Please log in for unlimited access.",
              { remaining: 3 - generateCount }
            )}
