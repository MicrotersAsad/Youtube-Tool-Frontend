...
const Test = () => {
                ...
                "https://api.openai.com/v1/chat/completions",
                {
                  ...
                  body: JSON.stringify({
                    ...
                    messages: [
                      {
                        role: "system",
                        content: `Generate a list of at least 20 SEO-friendly Channel Name for this keywords: "${tags.join(
                          ", "
                        )}".`,
                      },
  ...
  />
           ...
           <div className="flex items-center mt-4 mb-4 md:mt-0 ps-6 pe-6">
           <button
