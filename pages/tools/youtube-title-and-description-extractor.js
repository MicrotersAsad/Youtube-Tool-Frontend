...
const TitleDescriptionExtractor =({ meta, reviews, content, relatedTools, faqs,reactions,translations})  => {
  ...
  const handleReaction = async (action) => {
    ...
    try {
      const response = await fetch("/api/reactions", {
        ...
        body: JSON.stringify({
          category: "youtube-title-and-description-extractor",
          userId: user.email,
          action,
  ...
  const saveChannel = () => {
    ...
    const currentTool = {
      toolName: "Youtube Title&Description Extractor", // Name of the current tool
  ...
  {/* Open Graph Tags */}
  <meta property="og:url" content={`${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-title-and-description-extractor`} />
  ...
  <meta property="twitter:url" content={`${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-title-and-description-extractor`} />
  <meta name="twitter:title" content={meta?.title} />
  <meta name="twitter:description" content={meta?.description} />
  <meta name="twitter:image" content={meta?.image || ""} />
  
  {/* hreflang and Alternate Language Links */}
  <link rel="alternate" href={`${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-title-and-description-extractor`}  hrefLang="x-default" />
  <link rel="alternate" href={`${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-title-and-description-extractor`}  hrefLang="en" />
  {translations && Object.keys(translations).map(lang => (
    lang !== 'en' && (
      <link
        ...
        rel="alternate"
        hrefLang={lang}
        href={`${meta?.url}/${lang}/tools/youtube-title-and-description-extractor`}
      />
    )
  ))}
  </Head>
  ...
  <Script type="application/ld+json">
    {JSON.stringify({
      ...
      "@type": "WebPage",
      name: meta?.title,
      url: `${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-title-and-description-extractor`,
