...
const TrendingVideos =  ({ meta, reviews, content, relatedTools, faqs,reactions,translations,hreflangs}) => {
      ...
      <div className="bg-box">
        ...
        <Head>
            ...
            <link
              rel="canonical"
              href={`${meta?.url
                .replace("trendingVideos", "trending-videos")}`}
            />
            ...
            <meta
  name="twitter:domain"
  content={meta?.url.replace("tools/trendingVideos", "")}
/>
