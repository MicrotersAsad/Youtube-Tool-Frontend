  ...
  return (
    <>
      <div className="bg-box">
        ...
        <meta property="og:url"  content={`${meta?.url}/${i18n.language}/tools/title-generator`} />
        <meta property="og:title" content={meta?.title} />
        <meta property="og:description" content={meta?.description} />
        <meta property="og:image" content={meta?.image || ""} />
        <meta name="twitter:card" content={meta?.image || ""} />
        <meta property="twitter:domain"  content={`${meta?.url}/${i18n.language}/tools/title-generator`}  />
        <meta property="twitter:url"  content={`${meta?.url}/${i18n.language}/tools/title-generator`}  />
