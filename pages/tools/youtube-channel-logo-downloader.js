...
const YouTubeChannelLogoDownloader =  ({ meta, reviews, content, relatedTools, faqs,reactions,hreflangs}) => {
  ...
  const saveChannel = () => {
    const savedChannels = JSON.parse(localStorage.getItem('savedChannels') || '[]');
    const currentTool = {
      toolName: "YouTube Channel Logo Downloader", // Name of the current tool
      ...
      <div className="bg-box">
        ...
        <Head>
            ...
            <link
              ...
              href={`${meta?.url
                .toLowerCase()
                .replace("YouTube-Channel-Logo-Downloader", "youtube-channel-logo-downloader")}`}
            />
            ...
            <meta property="og:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732771498273-youtubechannellogodownloadb.png" />
            <meta property="og:image:secure_url" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732771498273-youtubechannellogodownloadb.png" />
            ...
            <meta
              name="twitter:domain"
              content={meta?.url
                .replace("tools/YouTube-Channel-Logo-Downloader", "")}
            />
            <meta
            ...
            <meta name="twitter:image" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732771498273-youtubechannellogodownloadb.png" />
            <meta name="twitter:site" content="@ytubetools" />
            <meta name="twitter:image:alt" content="https://ytubetools.s3.eu-north-1.amazonaws.com/uploads/1732771498273-youtubechannellogodownloadb.png" />
  ...
  {JSON.stringify({
    ...
    "@type": "WebPage",
    name: meta?.title,
    url: `${meta?.url}${i18n.language !== 'en' ? `/${i18n.language}` : ''}/tools/youtube-channel-logo-downloader`,
