      ...
      <div className="bg-box">
        ...
        <div className="max-w-7xl mx-auto p-4">
          <Head>
            ...
            <meta
              property="og:url"
              content="https://youtube-tool-frontend.vercel.app/tools/YouTube-Embed-Code-Generator"
            />
            <meta
              property="og:title"
            ...
            <script type="application/ld+json">
              {JSON.stringify({
                ...
                "@type": "WebPage",
                name: meta?.title,
                url: "https://youtube-tool-frontend.vercel.app/tools/YouTube-Embed-Code-Generator",
